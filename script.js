...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '8f58dcf7ffb6458d848890414e0f0355',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = "";
    const apiURL = "https://v2.jokeapi.dev/joke/Miscellaneous,Pun,Christmas?blacklistFlags=nsfw,religious,racist,sexist,explicit";
    try {
...
function toggleButton() {
    // The "disabled" property is a boolean, so we
    // make button.disabled the opposite of whatever it was.
